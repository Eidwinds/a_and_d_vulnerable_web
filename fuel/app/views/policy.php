<div class="policy">
<p>エーアンドディーイーコマース株式会社（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
<h3>第１条（プライバシー情報）</h3>
...
社名：エーアンドディーイーコマース株式会社<br>
担当部署：総務部 田中<br>
Eメールアドレス：tanaka@attack-and-defense.xxx</p>
<p class="over">以上</p>
</div>